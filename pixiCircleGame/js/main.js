...
let gameOverScoreLabel; //this will display the game over text to the player
let score = 0;
let life = 100;
let levelNum = 1;
let paused = true;
...
function createExplosion(x,y,frameWidth, frameHeight){ //with a little bit of tweaking this can work with an array of textures of any size ;)
...
function gameLoop(){
    ...
    //keep the ship on teh screen with clamp()
    let w2 = ship.width/2;
